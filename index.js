...
// nestedFunction can access the variable internal because it is a closure. Because of this it is able to reach outside of its scope and access the requested variable. 
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach(function(item){
      ...
      frontHabitat.push(`name: ${name}, scientific: ${scientific}`) 
    });
    return frontHabitat;
  }
  ...
  */
  ...
  function lowerCaseNames(array){
    const convertLowerCase = array.map(function(item){
  ...
  */
  ...
  function USApop(array){
    const populationSum = array.reduce(function(accumulator, item){
